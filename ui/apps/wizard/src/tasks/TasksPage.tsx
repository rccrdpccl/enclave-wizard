...
function TaskDetail({
  ...
  const {
    ...
    error: taskError,
    loading: taskLoading,
  } = usePolling(fetchTask, 3000, !taskDone);
    ...
    <Stack hasGutter>
      <StackItem>
        <Breadcrumb>
          ...
          <BreadcrumbItem isActive>{task.id.substring(0, 8)}...</BreadcrumbItem>
        </Breadcrumb>
      </StackItem>
                  ...
                  >
                    <SelectList>
                      <SelectOption
                        value="running"
                        hasCheckbox
                        isSelected={statusFilters.includes("running")}
                      >
                        Running
                      </SelectOption>
                      <SelectOption
                        value="successful"
                        hasCheckbox
                        isSelected={statusFilters.includes("successful")}
                      >
                        Successful
                      </SelectOption>
                      <SelectOption
                      ...
                      <SelectOption
                        value="canceled"
                        hasCheckbox
                        isSelected={statusFilters.includes("canceled")}
                      >
                        Canceled
                      </SelectOption>
                    </SelectList>
                  ...
                  >
                    <SelectList>
                      <SelectOption
                        value="deploy"
                        hasCheckbox
                        isSelected={typeFilters.includes("deploy")}
                      >
                        Full Deploy
                      </SelectOption>
                      <SelectOption
                        value="deploy-phase"
                        hasCheckbox
                        isSelected={typeFilters.includes("deploy-phase")}
                      >
                        Phase
                      </SelectOption>
                      <SelectOption
                        value="deploy-plugin"
                        hasCheckbox
                        isSelected={typeFilters.includes("deploy-plugin")}
                      >
                        Plugin
                      </SelectOption>
                    </SelectList>
          ...
          <Table aria-label="Task runs" variant="compact">
            ...
            <Tbody>
              {filteredRuns.map((run) => (
                ...
                >
                  <Td>
                    <TaskStatusLabel status={run.status} />
                  </Td>
                  <Td>
                    <TaskTypeLabel type={run.type} />
                  </Td>
                  <Td>{run.playbook}</Td>
                      ...
                      items={[
                        {
                          title: "Delete",
                          isDisabled:
                            run.status === "running" || deletingIds.has(run.id),
                          onClick: (e) =>
                            handleDeleteTask(
